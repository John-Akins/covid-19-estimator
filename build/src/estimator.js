...
const EstimateBestCase = data => {
  ...
  const infectionsByRequestedTime = InfectionRateByRequestedTime(currentlyInfected, data.periodType, data.timeToElapse);
  ...
  const dollarsInFlight = infectionsByRequestedTime * 0.65 * data.avgDailyIncomeInUSD * data.timeToElapse;
  return {
    currentlyInfected,
